...
Espatifilo, más comúnmente conocida como la planta de Cuna de Moisés o flor de la paz, es una de las
plantas para interiores más populares que filtra las toxinas dañinas del aire. Algunas de las toxinas que neutraliza
...
if entrada == "Espatifilo":
    ...
    print("¡Espatifilo! ¡No ", entrada, "!", sep="")
